...
<body style="background: url('images/hinh-nen-sach.jpg');">
	...
	<div class="container"
		...
		<html:form action="/themAcc" method="post" style="margin-left:50px">
			...
			<div class="row form-group">
				<label class="col-xs-4" style="color: white;">Quyền</label>
				<div class="col-xs-6">
