...
<body>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			...
			<div class="item">
				<img class="second-slide" src="image/banner1.png" alt="Second slide">
			</div>
			<div class="item">
		...
		<div class="row">
			<div class="col-lg-4">
				<img class="img-circle" src="image/sach1.jpg"
					alt="Generic placeholder image" width="140" height="140">
				<h2 class="title-book">Conan</h2>
				<p class="description">Sự thật nào sẽ được làm sáng tỏ đằng sau
					mối bất hòa giữa hai con người phục vụ công lí ở hai vị thế khác
					nhau - mật vụ FBI Akai và cảnh sát Amuro!?</p>
				<p>
					<a class="btn btn-default" href="detail.html" role="button">Xem
						thêm &raquo;</a>
				</p>
			...
			<div class="col-lg-4">
				...
				<h2 class="title-book">Sinh ra đâu phải để buồn</h2>
				<p class="description">"Mình sinh ra đâu phải để buồn", cuốn
					sách đánh dấu sự hợp tác ăn ý giữa Hamlet Trương và Iris Cao, "cặp
					đôi vàng văn học" được độc giả trẻ yêu mến sau nhiều tác phẩm trở
					thành hiện tượng như Thương nhau để đó, Ai rồi cũng khác, Mỉm cười
					cho qua...</p>
				<p>
					<a class="btn btn-default" href="detail.html" role="button">Xem
						thêm &raquo;</a>
			...
			<div class="row col-md-12">
				<center>
					<h1 style="margin-bottom: 40px;">
						<a href="/BookStore/category.do?categoryNum=TV"
							style="text-decoration: none; color: #5a5a5a;"> Sách Tiếng
							Việt</a>
					</h1>
				</center>
